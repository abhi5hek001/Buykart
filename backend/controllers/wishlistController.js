...
const wishlistController = {
    ...
    async addItem(req, res, next) {
        try {
            ...
            const wishlist = await wishlistService.addToWishlist(req.params.userId, product_id);
    ...
    async moveToCart(req, res, next) {
        try {
            ...
            const result = await wishlistService.moveToCart(req.params.userId, req.params.productId, quantity);
